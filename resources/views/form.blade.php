    ...
    <form action="{{route('users.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex gap-12 [&>div>label]:font-semibold text-gray-700 mb-8">
            <div class="text-center">
                <label for="image"
                    class="border h-60 border-gray-300 @error('image') is-invalid-image @enderror border-dashed rounded-md p-8 text-center flex flex-col items-center justify-center w-52 font-semibold text-gray-500 gap-4 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
